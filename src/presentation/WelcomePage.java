...
public class WelcomePage {
    ...
    public WelcomePage(List<User> users, BiConsumer<String, String> loginFunction, QuadStringConsumer addUserFunction, Consumer<String> deleteUserFunction) {
        ...
        { // Creates and adds the components to the panel
            ...
            addUserButton.addActionListener(e -> addUserPage.show());
    ...
    private static class UserSelectionPanel extends JPanel {
        ...
        private static class SelectUserButton extends JButton {
    ...
    private static class AddUserPage {
    ...
    @FunctionalInterface
    public interface QuadStringConsumer {
